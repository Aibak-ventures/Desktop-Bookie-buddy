...
@JsonKey(name: 'cooling_days', defaultValue: 0) int get coolingPeriodDuration;@JsonKey(name: 'cooling_period_mode', fromJson: CoolingPeriodMode.fromJson, defaultValue: CoolingPeriodMode.after, toJson: CoolingPeriodMode.toJson) CoolingPeriodMode get coolingPeriodMode;@JsonKey(name: 'default_action', fromJson: AddButtonDefaultAction.fromString, defaultValue: AddButtonDefaultAction.booking) AddButtonDefaultAction get addButtonDefaultAction;@JsonKey(name: 'search_client', defaultValue: false) bool get searchClient;@JsonKey(name: 'print_output_preference', fromJson: PrintOutputPreference.fromJson, defaultValue: PrintOutputPreference.askEveryTime, toJson: PrintOutputPreference.toJson) PrintOutputPreference get printOutputPreference;
...
@useResult
$Res call({
@JsonKey(name: 'cooling_days', defaultValue: 0) int coolingPeriodDuration,@JsonKey(name: 'cooling_period_mode', fromJson: CoolingPeriodMode.fromJson, defaultValue: CoolingPeriodMode.after, toJson: CoolingPeriodMode.toJson) CoolingPeriodMode coolingPeriodMode,@JsonKey(name: 'default_action', fromJson: AddButtonDefaultAction.fromString, defaultValue: AddButtonDefaultAction.booking) AddButtonDefaultAction addButtonDefaultAction,@JsonKey(name: 'search_client', defaultValue: false) bool searchClient,@JsonKey(name: 'print_output_preference', fromJson: PrintOutputPreference.fromJson, defaultValue: PrintOutputPreference.askEveryTime, toJson: PrintOutputPreference.toJson) PrintOutputPreference printOutputPreference
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: 'cooling_days', defaultValue: 0)  int coolingPeriodDuration, @JsonKey(name: 'cooling_period_mode', fromJson: CoolingPeriodMode.fromJson, defaultValue: CoolingPeriodMode.after, toJson: CoolingPeriodMode.toJson)  CoolingPeriodMode coolingPeriodMode, @JsonKey(name: 'default_action', fromJson: AddButtonDefaultAction.fromString, defaultValue: AddButtonDefaultAction.booking)  AddButtonDefaultAction addButtonDefaultAction, @JsonKey(name: 'search_client', defaultValue: false)  bool searchClient, @JsonKey(name: 'print_output_preference', fromJson: PrintOutputPreference.fromJson, defaultValue: PrintOutputPreference.askEveryTime, toJson: PrintOutputPreference.toJson)  PrintOutputPreference printOutputPreference)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ShopSettingsModel() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: 'cooling_days', defaultValue: 0)  int coolingPeriodDuration, @JsonKey(name: 'cooling_period_mode', fromJson: CoolingPeriodMode.fromJson, defaultValue: CoolingPeriodMode.after, toJson: CoolingPeriodMode.toJson)  CoolingPeriodMode coolingPeriodMode, @JsonKey(name: 'default_action', fromJson: AddButtonDefaultAction.fromString, defaultValue: AddButtonDefaultAction.booking)  AddButtonDefaultAction addButtonDefaultAction, @JsonKey(name: 'search_client', defaultValue: false)  bool searchClient, @JsonKey(name: 'print_output_preference', fromJson: PrintOutputPreference.fromJson, defaultValue: PrintOutputPreference.askEveryTime, toJson: PrintOutputPreference.toJson)  PrintOutputPreference printOutputPreference)  $default,) {final _that = this;
switch (_that) {
case _ShopSettingsModel():
return $default(_that.coolingPeriodDuration,_that.coolingPeriodMode,_that.addButtonDefaultAction,_that.searchClient,_that.printOutputPreference);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(name: 'cooling_days', defaultValue: 0)  int coolingPeriodDuration, @JsonKey(name: 'cooling_period_mode', fromJson: CoolingPeriodMode.fromJson, defaultValue: CoolingPeriodMode.after, toJson: CoolingPeriodMode.toJson)  CoolingPeriodMode coolingPeriodMode, @JsonKey(name: 'default_action', fromJson: AddButtonDefaultAction.fromString, defaultValue: AddButtonDefaultAction.booking)  AddButtonDefaultAction addButtonDefaultAction, @JsonKey(name: 'search_client', defaultValue: false)  bool searchClient, @JsonKey(name: 'print_output_preference', fromJson: PrintOutputPreference.fromJson, defaultValue: PrintOutputPreference.askEveryTime, toJson: PrintOutputPreference.toJson)  PrintOutputPreference printOutputPreference)?  $default,) {final _that = this;
switch (_that) {
case _ShopSettingsModel() when $default != null:
return $default(_that.coolingPeriodDuration,_that.coolingPeriodMode,_that.addButtonDefaultAction,_that.searchClient,_that.printOutputPreference);case _:
  return null;
...
@override@JsonKey(name: 'print_output_preference', fromJson: PrintOutputPreference.fromJson, defaultValue: PrintOutputPreference.askEveryTime, toJson: PrintOutputPreference.toJson) final  PrintOutputPreference printOutputPreference;
