...
class _CustomProductSearchFieldState extends State<CustomProductSearchField> {
  ...
  void initState() {
    ...
    searchTypes2 = [
      'Name',
      'Color',
      widget.mainServiceType.isVehicle ? 'Brand' : 'Category',
      'Model',
    ];
  }
    ...
    return ValueListenableBuilder(
      ...
      builder: (context, selectedSearchTypeIndex, child) => CustomSearchField(
        ...
        suffixIcon: ValueListenableBuilder<bool>(
          ...
          builder: (context, isFilterEnabled, child) {
            return IconButton(
              icon: Icon(
                Icons.tune,
              ...
              onPressed: () {
                if (widget.mainServiceType.isDress &&
                  ...
                  widget.priceRangeNotifier.value =
                      RangeValues(0, maxPriceNotifier.value);
                }
                ...
                showSearchTypeBottomSheet(
                  ...
                  isPriceFilterEnabled: widget.isPriceFilterEnabled,
                  maxPriceNotifier: maxPriceNotifier,
                  minPrice: 0,
                  priceRange: widget.priceRangeNotifier,
                  onPriceChanged: (range) {},
                  onApply: (type, range, isPriceEnabled) => widget.onApply(
                    type,
                    range,
                    isPriceEnabled,
