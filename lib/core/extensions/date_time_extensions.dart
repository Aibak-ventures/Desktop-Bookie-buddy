...
extension QuickDateFilters on DateTime {
  ...
  DateTime get monthStart => DateTime(year, month, 1).dateOnly;
...
extension TimeX on TimeOfDay {
  ...
  String formatToTime(
      {DateTime? date, bool is24Hour = true, bool addSeconds = false}) {
  ...
  TimeOfDay get clearedTime => TimeOfDay(
        hour: hour,
        minute: 0,
      );
}
