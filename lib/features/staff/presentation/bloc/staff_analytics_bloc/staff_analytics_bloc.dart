...
class StaffAnalyticsBloc
  ...
  final GetStaffAnalyticsReportUseCase _getStaffAnalyticsReport;
  StaffAnalyticsBloc(
      {required GetStaffAnalyticsReportUseCase getStaffAnalyticsReport})
      : _getStaffAnalyticsReport = getStaffAnalyticsReport,
        super(
  ...
  Future<void> _onGetAnalytics(
    ...
    try {
      final staffReport = await _getStaffAnalyticsReport.call(
