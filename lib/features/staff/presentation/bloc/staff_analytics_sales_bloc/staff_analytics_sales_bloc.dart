...
class StaffAnalyticsSalesBloc
  ...
  final GetStaffMonthlySalesUseCase _getStaffMonthlySales;
  StaffAnalyticsSalesBloc(
      {required GetStaffMonthlySalesUseCase getStaffMonthlySales})
      : _getStaffMonthlySales = getStaffMonthlySales,
  ...
  FutureOr<void> _onLoadSales(
    ...
    try {
      final result = await _getStaffMonthlySales.call(
