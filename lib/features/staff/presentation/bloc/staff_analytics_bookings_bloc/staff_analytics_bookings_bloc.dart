...
class StaffAnalyticsBookingsBloc
  ...
  final GetStaffMonthlyBookingsUseCase _getStaffMonthlyBookings;
  StaffAnalyticsBookingsBloc(
      {required GetStaffMonthlyBookingsUseCase getStaffMonthlyBookings})
      : _getStaffMonthlyBookings = getStaffMonthlyBookings,
  ...
  Future<void> _onLoadBookings(
    ...
    try {
      final result = await _getStaffMonthlyBookings.call(
