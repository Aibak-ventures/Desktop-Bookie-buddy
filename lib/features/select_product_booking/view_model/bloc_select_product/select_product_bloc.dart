...
class SelectProductBloc extends Bloc<SelectProductEvent, SelectProductState> {
  ...
  SelectProductBloc() : super(const _Loading()) {
  ...
  Future<void> _onLoadProducts(
      _LoadProducts event, Emitter<SelectProductState> emit) async {
    emit(const _Loading());
    try {
  ...
  Future<void> _onLoadNextPageProducts(
      _LoadNextPageProducts event, Emitter<SelectProductState> emit) async {
  ...
  Future<void> _onSearchProducts(
      _SearchProducts event, Emitter<SelectProductState> emit) async {
    emit(const _Loading());
  ...
  Future<void> _onLoadNextSearchResults(
      _LoadNextSearchResults event, Emitter<SelectProductState> emit) async {
    if (state is! _Loaded) return;
    final s = state as _Loaded;
