...
class _$LoadProductsImpl implements _LoadProducts {
  ...
  @override
  String toString() {
    return 'SelectProductEvent.loadProducts(serviceId: $serviceId, pickupDate: $pickupDate, returnDate: $returnDate, pickupTime: $pickupTime, returnTime: $returnTime, useAvailableProductsApi: $useAvailableProductsApi)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, serviceId, pickupDate,
      returnDate, pickupTime, returnTime, useAvailableProductsApi);
  ...
  TResult when<TResult extends Object?>({
    ...
    return loadProducts(serviceId, pickupDate, returnDate, pickupTime,
        returnTime, useAvailableProductsApi);
  }
...
abstract class _LoadProducts implements SelectProductEvent {
  const factory _LoadProducts(
      ...
      final TimeOfDay? pickupTime,
      final TimeOfDay? returnTime,
      final bool useAvailableProductsApi}) = _$LoadProductsImpl;
...
class _$SearchProductsImpl implements _SearchProducts {
  ...
  @override
  String toString() {
    return 'SelectProductEvent.searchProducts(serviceId: $serviceId, pickupDate: $pickupDate, returnDate: $returnDate, query: $query, type: $type, startPrice: $startPrice, endPrice: $endPrice, pickupTime: $pickupTime, returnTime: $returnTime, useAvailableProductsApi: $useAvailableProductsApi)';
  }
  ...
  TResult when<TResult extends Object?>({
    ...
    return searchProducts(serviceId, pickupDate, returnDate, query, type,
        startPrice, endPrice, pickupTime, returnTime, useAvailableProductsApi);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return searchProducts?.call(serviceId, pickupDate, returnDate, query, type,
        startPrice, endPrice, pickupTime, returnTime, useAvailableProductsApi);
  }
...
abstract class _SearchProducts implements SelectProductEvent {
  const factory _SearchProducts(
      ...
      final TimeOfDay? pickupTime,
      final TimeOfDay? returnTime,
      final bool useAvailableProductsApi}) = _$SearchProductsImpl;
...
abstract class _Loaded implements SelectProductState {
  const factory _Loaded(
      ...
      final TimeOfDay? pickupTime,
      final TimeOfDay? returnTime,
      final bool useAvailableProductsApi}) = _$LoadedImpl;
