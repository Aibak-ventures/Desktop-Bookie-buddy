...
@useResult
$Res call({
@JsonKey(includeToJson: false) int? id,@JsonKey(name: 'staff_id') int? staffId,@JsonKey(name: 'client_phone') String? clientPhone,@JsonKey(name: 'client_address') String? address,@JsonKey(name: 'sale_date') String? saleDate,@JsonKey(name: 'variants', toJson: _variantsToJson) List<ProductSelectedModel>? products,@JsonKey(name: 'decrease_stock') bool? stockCountDecrease,@JsonKey(name: 'description') String? description,@JsonKey(name: 'discount') int? discountAmount,@JsonKey(name: 'paid_amount') int? paidAmount,@JsonKey(name: 'payment_method', toJson: _paymentMethodToJson) PaymentMethod? paymentMethod,@JsonKey(name: 'send_invoice', includeToJson: true, includeFromJson: false) bool sendPdfToWhatsApp
});
...
class _SalesRequestModel implements SalesRequestModel {
  const _SalesRequestModel({@JsonKey(includeToJson: false) this.id, @JsonKey(name: 'staff_id') this.staffId, @JsonKey(name: 'client_phone') this.clientPhone, @JsonKey(name: 'client_address') this.address, @JsonKey(name: 'sale_date') this.saleDate, @JsonKey(name: 'variants', toJson: _variantsToJson) final  List<ProductSelectedModel>? products, @JsonKey(name: 'decrease_stock') this.stockCountDecrease, @JsonKey(name: 'description') this.description, @JsonKey(name: 'discount') this.discountAmount, @JsonKey(name: 'paid_amount') this.paidAmount, @JsonKey(name: 'payment_method', toJson: _paymentMethodToJson) this.paymentMethod = PaymentMethod.cash, @JsonKey(name: 'send_invoice', includeToJson: true, includeFromJson: false) this.sendPdfToWhatsApp = false}): _products = products;
...
@override@JsonKey(name: 'payment_method', toJson: _paymentMethodToJson) final  PaymentMethod? paymentMethod;
