...
@JsonKey(includeToJson: false) int? get id;@JsonKey(name: 'staff_id') int? get staffId;@JsonKey(name: 'client_phone') String? get clientPhone;@JsonKey(name: 'client_address') String? get address;@JsonKey(name: 'sale_date') String? get saleDate;@JsonKey(name: 'variants', toJson: _variantsToJson) List<ProductSelectedModel>? get products;@JsonKey(name: 'decrease_stock') bool? get stockCountDecrease;@JsonKey(name: 'description') String? get description;@JsonKey(name: 'discount') int? get discountAmount;@JsonKey(name: 'paid_amount') int? get paidAmount;@JsonKey(name: 'payments', toJson: _paymentsToJson) List<SalesPaymentRequestModel>? get payments;@JsonKey(name: 'send_invoice', includeToJson: true, includeFromJson: false) bool get sendPdfToWhatsApp;
...
@override
String toString() {
  return 'SalesRequestModel(id: $id, staffId: $staffId, clientPhone: $clientPhone, address: $address, saleDate: $saleDate, products: $products, stockCountDecrease: $stockCountDecrease, description: $description, discountAmount: $discountAmount, paidAmount: $paidAmount, payments: $payments, sendPdfToWhatsApp: $sendPdfToWhatsApp)';
}
...
@useResult
$Res call({
@JsonKey(includeToJson: false) int? id,@JsonKey(name: 'staff_id') int? staffId,@JsonKey(name: 'client_phone') String? clientPhone,@JsonKey(name: 'client_address') String? address,@JsonKey(name: 'sale_date') String? saleDate,@JsonKey(name: 'variants', toJson: _variantsToJson) List<ProductSelectedModel>? products,@JsonKey(name: 'decrease_stock') bool? stockCountDecrease,@JsonKey(name: 'description') String? description,@JsonKey(name: 'discount') int? discountAmount,@JsonKey(name: 'paid_amount') int? paidAmount,@JsonKey(name: 'payments', toJson: _paymentsToJson) List<SalesPaymentRequestModel>? payments,@JsonKey(name: 'send_invoice', includeToJson: true, includeFromJson: false) bool sendPdfToWhatsApp
});
...
as List<SalesPaymentRequestModel>?,sendPdfToWhatsApp: null == sendPdfToWhatsApp ? _self.sendPdfToWhatsApp : sendPdfToWhatsApp // ignore: cast_nullable_to_non_nullable
as bool,
  ));
}
...
class _SalesRequestModel implements SalesRequestModel {
  const _SalesRequestModel({@JsonKey(includeToJson: false) this.id, @JsonKey(name: 'staff_id') this.staffId, @JsonKey(name: 'client_phone') this.clientPhone, @JsonKey(name: 'client_address') this.address, @JsonKey(name: 'sale_date') this.saleDate, @JsonKey(name: 'variants', toJson: _variantsToJson) final  List<ProductSelectedModel>? products, @JsonKey(name: 'decrease_stock') this.stockCountDecrease, @JsonKey(name: 'description') this.description, @JsonKey(name: 'discount') this.discountAmount, @JsonKey(name: 'paid_amount') this.paidAmount, @JsonKey(name: 'payments', toJson: _paymentsToJson) final  List<SalesPaymentRequestModel>? payments, @JsonKey(name: 'send_invoice', includeToJson: true, includeFromJson: false) this.sendPdfToWhatsApp = false}): _products = products,_payments = payments;
...
@override@JsonKey(name: 'paid_amount') final  int? paidAmount;
 final  List<SalesPaymentRequestModel>? _payments;
@override@JsonKey(name: 'payments', toJson: _paymentsToJson) List<SalesPaymentRequestModel>? get payments {
