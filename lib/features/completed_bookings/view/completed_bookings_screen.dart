          ...
          children: [
            ...
            ValueListenableBuilder(
              ...
              builder: (context, isSearching, child) => isSearching
                  ? CustomSearchField(
                      ...
                      onChanged: (_) => _fetchCompletedWorksWithFilter(context),
            ...
            Expanded(
              child: RefreshIndicator.adaptive(
                onRefresh: () async => _fetchCompletedWorksWithFilter(context),
                child: Padding(
                  ...
                  child: BlocBuilder<CompletedBookingsBloc, CompletedBookingsState>(
                    builder: (context, state) => state.when(
                      ...
                      loaded: (completedWorks, nextPageUrl, isPaginating, _, __, ___) {
                          ...
                          child: Align(
                            ...
                            child: ConstrainedBox(
                              ...
                              child: ListView.builder(
                                ...
                                itemCount: completedWorks.length + (isPaginating ? 1 : 0),
                                      ...
                                      child: BookingCard(
                                        ...
                                        onTap: () async {
                                          ...
                                          if (bookingCubit.state.isModified) {
                                            ...
                                            context
                                                .read<CompletedBookingsBloc>()
                                                .add(CompletedBookingsEvent.updateBooking(
                                                  updated,
