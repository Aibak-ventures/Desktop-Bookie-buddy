...
as int?,isSecurityPaid: freezed == isSecurityPaid ? _self.isSecurityPaid : isSecurityPaid // ignore: cast_nullable_to_non_nullable
...
as int?,oldBookingAccountId: freezed == oldBookingAccountId ? _self.oldBookingAccountId : oldBookingAccountId // ignore: cast_nullable_to_non_nullable
...
@override@JsonKey(name: 'cooling_period_type', toJson: CoolingPeriodMode.tryToJson) final  CoolingPeriodMode? coolingPeriodType;
...
@override@JsonKey(name: 'account_id') final  int? oldBookingAccountId;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,clientId,staffId,client,address,bookedDate,pickupDate,returnDate,coolingPeriodDate,advanceAmount,securityAmount,isSecurityPaid,discountAmount,purchaseMode,description,const DeepCollectionEquality().hash(_payments),deliveryStatus,bookingStatus,const DeepCollectionEquality().hash(_products),otherDetails,const DeepCollectionEquality().hash(_additionalCharges),serviceId,pickupTime,returnTime,sendPdfToWhatsApp,coolingPeriodType,securityPaymentAccountId,oldBookingAccountId,taxAmount]);
