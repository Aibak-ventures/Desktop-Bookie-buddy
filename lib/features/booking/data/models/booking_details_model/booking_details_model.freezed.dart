...
as SecuritySummaryModel,securityPaymentMethod: freezed == securityPaymentMethod ? _self.securityPaymentMethod : securityPaymentMethod // ignore: cast_nullable_to_non_nullable
as PaymentMethod?,
  ));
}
/// Create a copy of BookingDetailsModel
...
@override@JsonKey(name: 'security_payment_method', fromJson: PaymentMethod.tryFromJson) final  PaymentMethod? securityPaymentMethod;
