...
mixin _$BookingDetailsModel {
 ...
 int get id;@JsonKey(name: 'shop_booking_id') String get invoiceId; String? get pickupDate; String get returnDate;@JsonKey(name: 'pickup_time') String? get pickupTime;@JsonKey(name: 'return_time') String? get returnTime;@JsonKey(name: 'cooling_period_end') String? get coolingPeriodDate;// Unused by toEntity() below — otherDetails.coolingPeriodType is the
...
@JsonKey(name: 'cooling_period_type') String? get coolingPeriodType;@JsonKey(name: 'total_amount') int get totalAmount;@JsonKey(name: 'total_payable') int? get totalPayable;@JsonKey(name: 'balance', defaultValue: 0) int get balanceAmount; int? get discountAmount;@JsonKey(name: 'advance_amount') int get paidAmount;@JsonKey(name: 'total_amount_with_security') int? get totalAmountWithSecurity;@JsonKey(name: 'advance_amount_with_security') int? get paidAmountWithSecurity; int? get securityAmount;@JsonKey(fromJson: PurchaseMode.fromJson, toJson: PurchaseMode.toJson, defaultValue: PurchaseMode.normal) PurchaseMode get purchaseMode;@JsonKey(fromJson: BookingStatus.fromJson, toJson: BookingStatus.toJson, defaultValue: BookingStatus.upcoming) BookingStatus get bookingStatus;@JsonKey(fromJson: PaymentStatus.fromBool, toJson: PaymentStatus.toJson, defaultValue: PaymentStatus.pending) PaymentStatus get paymentStatus;@JsonKey(fromJson: DeliveryStatus.fromJson, toJson: DeliveryStatus.toJson, defaultValue: DeliveryStatus.booked) DeliveryStatus get deliveryStatus;@JsonKey(name: 'staff_name') String? get staffName;@JsonKey(name: 'staff_id') int? get staffId;// A json field that store frontend defined fields. mainly to store extra details
@JsonKey(name: 'details', defaultValue: BookingOtherDetailsModel.empty) BookingOtherDetailsModel get otherDetails;@JsonKey(name: 'created_at') String get bookedDate;@JsonKey(name: 'completed_at') String? get bookingCompletedDate;@JsonKey(name: 'client_address') String? get address; ClientModel get client; String? get description; List<dynamic> get documents; List<ProductInfoModel> get bookedItems;@JsonKey(name: 'additional_charges') List<AdditionalChargesModel> get additionalCharges;@JsonKey(name: 'payments') List<BookingDetailsPaymentHistoryModel> get payments;@JsonKey(name: 'refunds', fromJson: _refundsFromJson) List<BookingDetailsRefundHistoryModel> get refunds;@JsonKey(name: 'total_refunded') double get totalRefunded;@JsonKey(name: 'refundable_balance') double get refundableBalance;@JsonKey(name: 'security_summary') SecuritySummaryModel get securitySummary;@JsonKey(name: 'security_adjustments') List<BookingDetailsSecurityRefundHistoryModel> get securityTransactionHistory;@JsonKey(name: 'security_amount_is_paid') bool get isSecurityPaid;@JsonKey(name: 'security') BookingSecurityPaymentModel? get securityPayment;@JsonKey(name: 'security_account_name') String? get securityAccountName;@JsonKey(name: 'security_account_id') int? get securityAccountId;// API currently sends a single `tax` object; modeled as a list so that
...
@useResult
$Res call({
 int id,@JsonKey(name: 'shop_booking_id') String invoiceId, String? pickupDate, String returnDate,@JsonKey(name: 'pickup_time') String? pickupTime,@JsonKey(name: 'return_time') String? returnTime,@JsonKey(name: 'cooling_period_end') String? coolingPeriodDate,@JsonKey(name: 'cooling_period_type') String? coolingPeriodType,@JsonKey(name: 'total_amount') int totalAmount,@JsonKey(name: 'total_payable') int? totalPayable,@JsonKey(name: 'balance', defaultValue: 0) int balanceAmount, int? discountAmount,@JsonKey(name: 'advance_amount') int paidAmount,@JsonKey(name: 'total_amount_with_security') int? totalAmountWithSecurity,@JsonKey(name: 'advance_amount_with_security') int? paidAmountWithSecurity, int? securityAmount,@JsonKey(fromJson: PurchaseMode.fromJson, toJson: PurchaseMode.toJson, defaultValue: PurchaseMode.normal) PurchaseMode purchaseMode,@JsonKey(fromJson: BookingStatus.fromJson, toJson: BookingStatus.toJson, defaultValue: BookingStatus.upcoming) BookingStatus bookingStatus,@JsonKey(fromJson: PaymentStatus.fromBool, toJson: PaymentStatus.toJson, defaultValue: PaymentStatus.pending) PaymentStatus paymentStatus,@JsonKey(fromJson: DeliveryStatus.fromJson, toJson: DeliveryStatus.toJson, defaultValue: DeliveryStatus.booked) DeliveryStatus deliveryStatus,@JsonKey(name: 'staff_name') String? staffName,@JsonKey(name: 'staff_id') int? staffId,@JsonKey(name: 'details', defaultValue: BookingOtherDetailsModel.empty) BookingOtherDetailsModel otherDetails,@JsonKey(name: 'created_at') String bookedDate,@JsonKey(name: 'completed_at') String? bookingCompletedDate,@JsonKey(name: 'client_address') String? address, ClientModel client, String? description, List<dynamic> documents, List<ProductInfoModel> bookedItems,@JsonKey(name: 'additional_charges') List<AdditionalChargesModel> additionalCharges,@JsonKey(name: 'payments') List<BookingDetailsPaymentHistoryModel> payments,@JsonKey(name: 'refunds', fromJson: _refundsFromJson) List<BookingDetailsRefundHistoryModel> refunds,@JsonKey(name: 'total_refunded') double totalRefunded,@JsonKey(name: 'refundable_balance') double refundableBalance,@JsonKey(name: 'security_summary') SecuritySummaryModel securitySummary,@JsonKey(name: 'security_adjustments') List<BookingDetailsSecurityRefundHistoryModel> securityTransactionHistory,@JsonKey(name: 'security_amount_is_paid') bool isSecurityPaid,@JsonKey(name: 'security') BookingSecurityPaymentModel? securityPayment,@JsonKey(name: 'security_account_name') String? securityAccountName,@JsonKey(name: 'security_account_id') int? securityAccountId,@JsonKey(name: 'tax', fromJson: AppliedTaxModel.listFromJson) List<AppliedTaxModel> appliedTaxes
});


$BookingOtherDetailsModelCopyWith<$Res> get otherDetails;$ClientModelCopyWith<$Res> get client;$SecuritySummaryModelCopyWith<$Res> get securitySummary;$BookingSecurityPaymentModelCopyWith<$Res>? get securityPayment;
...
/// Create a copy of BookingDetailsModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? invoiceId = null,Object? pickupDate = freezed,Object? returnDate = null,Object? pickupTime = freezed,Object? returnTime = freezed,Object? coolingPeriodDate = freezed,Object? coolingPeriodType = freezed,Object? totalAmount = null,Object? totalPayable = freezed,Object? balanceAmount = null,Object? discountAmount = freezed,Object? paidAmount = null,Object? totalAmountWithSecurity = freezed,Object? paidAmountWithSecurity = freezed,Object? securityAmount = freezed,Object? purchaseMode = null,Object? bookingStatus = null,Object? paymentStatus = null,Object? deliveryStatus = null,Object? staffName = freezed,Object? staffId = freezed,Object? otherDetails = null,Object? bookedDate = null,Object? bookingCompletedDate = freezed,Object? address = freezed,Object? client = null,Object? description = freezed,Object? documents = null,Object? bookedItems = null,Object? additionalCharges = null,Object? payments = null,Object? refunds = null,Object? totalRefunded = null,Object? refundableBalance = null,Object? securitySummary = null,Object? securityTransactionHistory = null,Object? isSecurityPaid = null,Object? securityPayment = freezed,Object? securityAccountName = freezed,Object? securityAccountId = freezed,Object? appliedTaxes = null,}) {
...
as int,totalPayable: freezed == totalPayable ? _self.totalPayable : totalPayable // ignore: cast_nullable_to_non_nullable
...
as int,totalAmountWithSecurity: freezed == totalAmountWithSecurity ? _self.totalAmountWithSecurity : totalAmountWithSecurity // ignore: cast_nullable_to_non_nullable
as int?,paidAmountWithSecurity: freezed == paidAmountWithSecurity ? _self.paidAmountWithSecurity : paidAmountWithSecurity // ignore: cast_nullable_to_non_nullable
...
as List<BookingDetailsRefundHistoryModel>,totalRefunded: null == totalRefunded ? _self.totalRefunded : totalRefunded // ignore: cast_nullable_to_non_nullable
...
as SecuritySummaryModel,securityTransactionHistory: null == securityTransactionHistory ? _self.securityTransactionHistory : securityTransactionHistory // ignore: cast_nullable_to_non_nullable
as List<BookingDetailsSecurityRefundHistoryModel>,isSecurityPaid: null == isSecurityPaid ? _self.isSecurityPaid : isSecurityPaid // ignore: cast_nullable_to_non_nullable
as bool,securityPayment: freezed == securityPayment ? _self.securityPayment : securityPayment // ignore: cast_nullable_to_non_nullable
as BookingSecurityPaymentModel?,securityAccountName: freezed == securityAccountName ? _self.securityAccountName : securityAccountName // ignore: cast_nullable_to_non_nullable
as String?,securityAccountId: freezed == securityAccountId ? _self.securityAccountId : securityAccountId // ignore: cast_nullable_to_non_nullable
...
@override
@pragma('vm:prefer-inline')
$BookingSecurityPaymentModelCopyWith<$Res>? get securityPayment {
    if (_self.securityPayment == null) {
    return null;
  }

  return $BookingSecurityPaymentModelCopyWith<$Res>(_self.securityPayment!, (value) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id, @JsonKey(name: 'shop_booking_id')  String invoiceId,  String? pickupDate,  String returnDate, @JsonKey(name: 'pickup_time')  String? pickupTime, @JsonKey(name: 'return_time')  String? returnTime, @JsonKey(name: 'cooling_period_end')  String? coolingPeriodDate, @JsonKey(name: 'cooling_period_type')  String? coolingPeriodType, @JsonKey(name: 'total_amount')  int totalAmount, @JsonKey(name: 'total_payable')  int? totalPayable, @JsonKey(name: 'balance', defaultValue: 0)  int balanceAmount,  int? discountAmount, @JsonKey(name: 'advance_amount')  int paidAmount, @JsonKey(name: 'total_amount_with_security')  int? totalAmountWithSecurity, @JsonKey(name: 'advance_amount_with_security')  int? paidAmountWithSecurity,  int? securityAmount, @JsonKey(fromJson: PurchaseMode.fromJson, toJson: PurchaseMode.toJson, defaultValue: PurchaseMode.normal)  PurchaseMode purchaseMode, @JsonKey(fromJson: BookingStatus.fromJson, toJson: BookingStatus.toJson, defaultValue: BookingStatus.upcoming)  BookingStatus bookingStatus, @JsonKey(fromJson: PaymentStatus.fromBool, toJson: PaymentStatus.toJson, defaultValue: PaymentStatus.pending)  PaymentStatus paymentStatus, @JsonKey(fromJson: DeliveryStatus.fromJson, toJson: DeliveryStatus.toJson, defaultValue: DeliveryStatus.booked)  DeliveryStatus deliveryStatus, @JsonKey(name: 'staff_name')  String? staffName, @JsonKey(name: 'staff_id')  int? staffId, @JsonKey(name: 'details', defaultValue: BookingOtherDetailsModel.empty)  BookingOtherDetailsModel otherDetails, @JsonKey(name: 'created_at')  String bookedDate, @JsonKey(name: 'completed_at')  String? bookingCompletedDate, @JsonKey(name: 'client_address')  String? address,  ClientModel client,  String? description,  List<dynamic> documents,  List<ProductInfoModel> bookedItems, @JsonKey(name: 'additional_charges')  List<AdditionalChargesModel> additionalCharges, @JsonKey(name: 'payments')  List<BookingDetailsPaymentHistoryModel> payments, @JsonKey(name: 'refunds', fromJson: _refundsFromJson)  List<BookingDetailsRefundHistoryModel> refunds, @JsonKey(name: 'total_refunded')  double totalRefunded, @JsonKey(name: 'refundable_balance')  double refundableBalance, @JsonKey(name: 'security_summary')  SecuritySummaryModel securitySummary, @JsonKey(name: 'security_adjustments')  List<BookingDetailsSecurityRefundHistoryModel> securityTransactionHistory, @JsonKey(name: 'security_amount_is_paid')  bool isSecurityPaid, @JsonKey(name: 'security')  BookingSecurityPaymentModel? securityPayment, @JsonKey(name: 'security_account_name')  String? securityAccountName, @JsonKey(name: 'security_account_id')  int? securityAccountId, @JsonKey(name: 'tax', fromJson: AppliedTaxModel.listFromJson)  List<AppliedTaxModel> appliedTaxes)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _BookingDetailsModel() when $default != null:
return $default(_that.id,_that.invoiceId,_that.pickupDate,_that.returnDate,_that.pickupTime,_that.returnTime,_that.coolingPeriodDate,_that.coolingPeriodType,_that.totalAmount,_that.totalPayable,_that.balanceAmount,_that.discountAmount,_that.paidAmount,_that.totalAmountWithSecurity,_that.paidAmountWithSecurity,_that.securityAmount,_that.purchaseMode,_that.bookingStatus,_that.paymentStatus,_that.deliveryStatus,_that.staffName,_that.staffId,_that.otherDetails,_that.bookedDate,_that.bookingCompletedDate,_that.address,_that.client,_that.description,_that.documents,_that.bookedItems,_that.additionalCharges,_that.payments,_that.refunds,_that.totalRefunded,_that.refundableBalance,_that.securitySummary,_that.securityTransactionHistory,_that.isSecurityPaid,_that.securityPayment,_that.securityAccountName,_that.securityAccountId,_that.appliedTaxes);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int id, @JsonKey(name: 'shop_booking_id')  String invoiceId,  String? pickupDate,  String returnDate, @JsonKey(name: 'pickup_time')  String? pickupTime, @JsonKey(name: 'return_time')  String? returnTime, @JsonKey(name: 'cooling_period_end')  String? coolingPeriodDate, @JsonKey(name: 'cooling_period_type')  String? coolingPeriodType, @JsonKey(name: 'total_amount')  int totalAmount, @JsonKey(name: 'total_payable')  int? totalPayable, @JsonKey(name: 'balance', defaultValue: 0)  int balanceAmount,  int? discountAmount, @JsonKey(name: 'advance_amount')  int paidAmount, @JsonKey(name: 'total_amount_with_security')  int? totalAmountWithSecurity, @JsonKey(name: 'advance_amount_with_security')  int? paidAmountWithSecurity,  int? securityAmount, @JsonKey(fromJson: PurchaseMode.fromJson, toJson: PurchaseMode.toJson, defaultValue: PurchaseMode.normal)  PurchaseMode purchaseMode, @JsonKey(fromJson: BookingStatus.fromJson, toJson: BookingStatus.toJson, defaultValue: BookingStatus.upcoming)  BookingStatus bookingStatus, @JsonKey(fromJson: PaymentStatus.fromBool, toJson: PaymentStatus.toJson, defaultValue: PaymentStatus.pending)  PaymentStatus paymentStatus, @JsonKey(fromJson: DeliveryStatus.fromJson, toJson: DeliveryStatus.toJson, defaultValue: DeliveryStatus.booked)  DeliveryStatus deliveryStatus, @JsonKey(name: 'staff_name')  String? staffName, @JsonKey(name: 'staff_id')  int? staffId, @JsonKey(name: 'details', defaultValue: BookingOtherDetailsModel.empty)  BookingOtherDetailsModel otherDetails, @JsonKey(name: 'created_at')  String bookedDate, @JsonKey(name: 'completed_at')  String? bookingCompletedDate, @JsonKey(name: 'client_address')  String? address,  ClientModel client,  String? description,  List<dynamic> documents,  List<ProductInfoModel> bookedItems, @JsonKey(name: 'additional_charges')  List<AdditionalChargesModel> additionalCharges, @JsonKey(name: 'payments')  List<BookingDetailsPaymentHistoryModel> payments, @JsonKey(name: 'refunds', fromJson: _refundsFromJson)  List<BookingDetailsRefundHistoryModel> refunds, @JsonKey(name: 'total_refunded')  double totalRefunded, @JsonKey(name: 'refundable_balance')  double refundableBalance, @JsonKey(name: 'security_summary')  SecuritySummaryModel securitySummary, @JsonKey(name: 'security_adjustments')  List<BookingDetailsSecurityRefundHistoryModel> securityTransactionHistory, @JsonKey(name: 'security_amount_is_paid')  bool isSecurityPaid, @JsonKey(name: 'security')  BookingSecurityPaymentModel? securityPayment, @JsonKey(name: 'security_account_name')  String? securityAccountName, @JsonKey(name: 'security_account_id')  int? securityAccountId, @JsonKey(name: 'tax', fromJson: AppliedTaxModel.listFromJson)  List<AppliedTaxModel> appliedTaxes)  $default,) {final _that = this;
switch (_that) {
case _BookingDetailsModel():
return $default(_that.id,_that.invoiceId,_that.pickupDate,_that.returnDate,_that.pickupTime,_that.returnTime,_that.coolingPeriodDate,_that.coolingPeriodType,_that.totalAmount,_that.totalPayable,_that.balanceAmount,_that.discountAmount,_that.paidAmount,_that.totalAmountWithSecurity,_that.paidAmountWithSecurity,_that.securityAmount,_that.purchaseMode,_that.bookingStatus,_that.paymentStatus,_that.deliveryStatus,_that.staffName,_that.staffId,_that.otherDetails,_that.bookedDate,_that.bookingCompletedDate,_that.address,_that.client,_that.description,_that.documents,_that.bookedItems,_that.additionalCharges,_that.payments,_that.refunds,_that.totalRefunded,_that.refundableBalance,_that.securitySummary,_that.securityTransactionHistory,_that.isSecurityPaid,_that.securityPayment,_that.securityAccountName,_that.securityAccountId,_that.appliedTaxes);case _:
  throw StateError('Unexpected subclass');
...
class _BookingDetailsModel implements BookingDetailsModel {
  const _BookingDetailsModel({required this.id, @JsonKey(name: 'shop_booking_id') required this.invoiceId, required this.pickupDate, required this.returnDate, @JsonKey(name: 'pickup_time') this.pickupTime, @JsonKey(name: 'return_time') this.returnTime, @JsonKey(name: 'cooling_period_end') this.coolingPeriodDate, @JsonKey(name: 'cooling_period_type') this.coolingPeriodType, @JsonKey(name: 'total_amount') required this.totalAmount, @JsonKey(name: 'total_payable') this.totalPayable, @JsonKey(name: 'balance', defaultValue: 0) required this.balanceAmount, this.discountAmount, @JsonKey(name: 'advance_amount') required this.paidAmount, @JsonKey(name: 'total_amount_with_security') this.totalAmountWithSecurity, @JsonKey(name: 'advance_amount_with_security') this.paidAmountWithSecurity, this.securityAmount, @JsonKey(fromJson: PurchaseMode.fromJson, toJson: PurchaseMode.toJson, defaultValue: PurchaseMode.normal) required this.purchaseMode, @JsonKey(fromJson: BookingStatus.fromJson, toJson: BookingStatus.toJson, defaultValue: BookingStatus.upcoming) required this.bookingStatus, @JsonKey(fromJson: PaymentStatus.fromBool, toJson: PaymentStatus.toJson, defaultValue: PaymentStatus.pending) required this.paymentStatus, @JsonKey(fromJson: DeliveryStatus.fromJson, toJson: DeliveryStatus.toJson, defaultValue: DeliveryStatus.booked) required this.deliveryStatus, @JsonKey(name: 'staff_name') this.staffName, @JsonKey(name: 'staff_id') this.staffId, @JsonKey(name: 'details', defaultValue: BookingOtherDetailsModel.empty) required this.otherDetails, @JsonKey(name: 'created_at') required this.bookedDate, @JsonKey(name: 'completed_at') this.bookingCompletedDate, @JsonKey(name: 'client_address') this.address, required this.client, this.description, final  List<dynamic> documents = const [], required final  List<ProductInfoModel> bookedItems, @JsonKey(name: 'additional_charges') final  List<AdditionalChargesModel> additionalCharges = const [], @JsonKey(name: 'payments') final  List<BookingDetailsPaymentHistoryModel> payments = const [], @JsonKey(name: 'refunds', fromJson: _refundsFromJson) final  List<BookingDetailsRefundHistoryModel> refunds = const [], @JsonKey(name: 'total_refunded') this.totalRefunded = 0.0, @JsonKey(name: 'refundable_balance') this.refundableBalance = 0.0, @JsonKey(name: 'security_summary') this.securitySummary = SecuritySummaryModel.empty, @JsonKey(name: 'security_adjustments') final  List<BookingDetailsSecurityRefundHistoryModel> securityTransactionHistory = const [], @JsonKey(name: 'security_amount_is_paid') this.isSecurityPaid = false, @JsonKey(name: 'security') this.securityPayment, @JsonKey(name: 'security_account_name') this.securityAccountName, @JsonKey(name: 'security_account_id') this.securityAccountId, @JsonKey(name: 'tax', fromJson: AppliedTaxModel.listFromJson) final  List<AppliedTaxModel> appliedTaxes = const []}): _documents = documents,_bookedItems = bookedItems,_additionalCharges = additionalCharges,_payments = payments,_refunds = refunds,_securityTransactionHistory = securityTransactionHistory,_appliedTaxes = appliedTaxes;
...
@override@JsonKey(name: 'return_time') final  String? returnTime;
...
@override@JsonKey(name: 'total_payable') final  int? totalPayable;
@override@JsonKey(name: 'balance', defaultValue: 0) final  int balanceAmount;
@override final  int? discountAmount;
@override@JsonKey(name: 'advance_amount') final  int paidAmount;
@override@JsonKey(name: 'total_amount_with_security') final  int? totalAmountWithSecurity;
@override@JsonKey(name: 'advance_amount_with_security') final  int? paidAmountWithSecurity;
@override final  int? securityAmount;
@override@JsonKey(fromJson: PurchaseMode.fromJson, toJson: PurchaseMode.toJson, defaultValue: PurchaseMode.normal) final  PurchaseMode purchaseMode;
@override@JsonKey(fromJson: BookingStatus.fromJson, toJson: BookingStatus.toJson, defaultValue: BookingStatus.upcoming) final  BookingStatus bookingStatus;
...
@override@JsonKey(fromJson: DeliveryStatus.fromJson, toJson: DeliveryStatus.toJson, defaultValue: DeliveryStatus.booked) final  DeliveryStatus deliveryStatus;
...
@override@JsonKey(name: 'payments') List<BookingDetailsPaymentHistoryModel> get payments {
 ...
 final  List<BookingDetailsRefundHistoryModel> _refunds;
@override@JsonKey(name: 'refunds', fromJson: _refundsFromJson) List<BookingDetailsRefundHistoryModel> get refunds {
...
@override@JsonKey(name: 'security_summary') final  SecuritySummaryModel securitySummary;
 final  List<BookingDetailsSecurityRefundHistoryModel> _securityTransactionHistory;
@override@JsonKey(name: 'security_adjustments') List<BookingDetailsSecurityRefundHistoryModel> get securityTransactionHistory {
...
@override@JsonKey(name: 'security_amount_is_paid') final  bool isSecurityPaid;
@override@JsonKey(name: 'security') final  BookingSecurityPaymentModel? securityPayment;
@override@JsonKey(name: 'security_account_name') final  String? securityAccountName;
@override@JsonKey(name: 'security_account_id') final  int? securityAccountId;
...
@override $BookingOtherDetailsModelCopyWith<$Res> get otherDetails;@override $ClientModelCopyWith<$Res> get client;@override $SecuritySummaryModelCopyWith<$Res> get securitySummary;@override $BookingSecurityPaymentModelCopyWith<$Res>? get securityPayment;
...
as double,refundableBalance: null == refundableBalance ? _self.refundableBalance : refundableBalance // ignore: cast_nullable_to_non_nullable
as double,securitySummary: null == securitySummary ? _self.securitySummary : securitySummary // ignore: cast_nullable_to_non_nullable
as SecuritySummaryModel,securityTransactionHistory: null == securityTransactionHistory ? _self._securityTransactionHistory : securityTransactionHistory // ignore: cast_nullable_to_non_nullable
as List<BookingDetailsSecurityRefundHistoryModel>,isSecurityPaid: null == isSecurityPaid ? _self.isSecurityPaid : isSecurityPaid // ignore: cast_nullable_to_non_nullable
as bool,securityPayment: freezed == securityPayment ? _self.securityPayment : securityPayment // ignore: cast_nullable_to_non_nullable
as BookingSecurityPaymentModel?,securityAccountName: freezed == securityAccountName ? _self.securityAccountName : securityAccountName // ignore: cast_nullable_to_non_nullable
as String?,securityAccountId: freezed == securityAccountId ? _self.securityAccountId : securityAccountId // ignore: cast_nullable_to_non_nullable
