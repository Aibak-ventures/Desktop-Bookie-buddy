...
mixin _$BookingDetailsModel {
 ...
 int get id;@JsonKey(name: 'shop_booking_id') String get invoiceId; String? get pickupDate; String get returnDate;@JsonKey(name: 'pickup_time') String? get pickupTime;@JsonKey(name: 'return_time') String? get returnTime;@JsonKey(name: 'cooling_period_end') String? get coolingPeriodDate;@JsonKey(name: 'cooling_period_type') String? get coolingPeriodType;@JsonKey(name: 'total_amount') int get totalAmount;@JsonKey(name: 'total_payable') int? get totalPayable;@JsonKey(name: 'balance', defaultValue: 0) int get balanceAmount; int? get discountAmount;@JsonKey(name: 'advance_amount') int get paidAmount;@JsonKey(name: 'total_amount_with_security') int? get totalAmountWithSecurity;@JsonKey(name: 'advance_amount_with_security') int? get paidAmountWithSecurity; int? get securityAmount;@JsonKey(fromJson: PurchaseMode.fromJson, toJson: PurchaseMode.toJson, defaultValue: PurchaseMode.normal) PurchaseMode get purchaseMode;@JsonKey(fromJson: BookingStatus.fromString, toJson: BookingStatus.toJson, defaultValue: BookingStatus.upcoming) BookingStatus get bookingStatus;@JsonKey(fromJson: PaymentStatus.fromBool, toJson: PaymentStatus.toJson, defaultValue: PaymentStatus.pending) PaymentStatus get paymentStatus;@JsonKey(fromJson: DeliveryStatus.fromString, toJson: DeliveryStatus.toJson, defaultValue: DeliveryStatus.booked) DeliveryStatus get deliveryStatus;@JsonKey(name: 'staff_name') String? get staffName;@JsonKey(name: 'staff_id') int? get staffId;@JsonKey(name: 'details', defaultValue: BookingOtherDetailsModel.empty) BookingOtherDetailsModel get otherDetails;@JsonKey(name: 'created_at') String get bookedDate;@JsonKey(name: 'completed_at') String? get bookingCompletedDate;@JsonKey(name: 'client_address') String? get address; ClientModel get client; String? get description; List<dynamic> get documents; List<ProductInfoModel> get bookedItems;@JsonKey(name: 'additional_charges') List<AdditionalChargesModel> get additionalCharges;@JsonKey(name: 'payments') List<BookingDetailsPaymentHistoryModel> get payments; List<dynamic> get refunds;@JsonKey(name: 'total_refunded') double get totalRefunded;@JsonKey(name: 'refundable_balance') double get refundableBalance;@JsonKey(name: 'security_summary') SecuritySummaryModel get securitySummary;@JsonKey(name: 'security_adjustments') List<BookingDetailsSecurityRefundHistoryModel> get securityTransactionHistory;@JsonKey(name: 'security_amount_is_paid') bool get isSecurityPaid;@JsonKey(name: 'security') BookingSecurityPaymentModel? get securityPayment;@JsonKey(name: 'security_account_name') String? get securityAccountName;@JsonKey(name: 'security_account_id') int? get securityAccountId;// API currently sends a single `tax` object; modeled as a list so that
