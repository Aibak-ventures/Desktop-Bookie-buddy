...
class _DesktopBookingItemModel implements DesktopBookingItemModel {
  const _DesktopBookingItemModel({required this.id, @JsonKey(name: 'shop_booking_id') required this.shopBookingId, required this.client, @JsonKey(name: 'pickup_date') required this.pickupDate, @JsonKey(name: 'return_date') required this.returnDate, @JsonKey(name: 'payment_status', fromJson: _paymentStatusFromBool, toJson: _paymentStatusToBool) required this.paymentStatus, @JsonKey(name: 'staff_name') this.staffName, @JsonKey(name: 'staff_color') this.staffColor, @JsonKey(name: 'delivery_status', fromJson: DeliveryStatus.fromJson, toJson: DeliveryStatus.toJson) this.deliveryStatus, @JsonKey(name: 'created_at') required this.createdAt, @JsonKey(name: 'booked_items') required this.bookedItems, @JsonKey(name: 'advance_amount', defaultValue: 0) required this.advanceAmount, @JsonKey(name: 'remaining_amount', defaultValue: 0) required this.remainingAmount, @JsonKey(name: 'total_amount_after_discount', defaultValue: 0) required this.totalAmount});
...
@override@JsonKey(name: 'delivery_status', fromJson: DeliveryStatus.fromJson, toJson: DeliveryStatus.toJson) final  DeliveryStatus? deliveryStatus;
