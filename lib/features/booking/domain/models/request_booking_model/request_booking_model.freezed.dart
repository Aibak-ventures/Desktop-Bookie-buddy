...
/// @nodoc
abstract mixin class $RequestBookingModelCopyWith<$Res>  {
  factory $RequestBookingModelCopyWith(RequestBookingModel value, $Res Function(RequestBookingModel) _then) = _$RequestBookingModelCopyWithImpl;
@useResult
$Res call({
@JsonKey(name: 'client_id') int? clientId,@JsonKey(name: 'staff_id') int? staffId,@JsonKey(name: 'client', toJson: _clientToJson, includeIfNull: false) ClientRequestModel? client,@JsonKey(name: 'client_address') String? address,@JsonKey(name: 'booked_date') String? bookedDate,@JsonKey(name: 'pickup_date') String? pickupDate,@JsonKey(name: 'return_date') String? returnDate,@JsonKey(name: 'cooling_period_end') String? coolingPeriodDate,@JsonKey(name: 'advance_amount') int? advanceAmount,@JsonKey(name: 'security_amount') int? securityAmount,@JsonKey(name: 'discount_amount') int? discountAmount,@JsonKey(name: 'purchase_mode') String? purchaseMode,@JsonKey(name: 'description') String? description,@JsonKey(name: 'payment_method') PaymentMethod? paymentMethod,@JsonKey(name: 'delivery_status', toJson: DeliveryStatus.toJson) DeliveryStatus? deliveryStatus,@JsonKey(name: 'booking_status', toJson: BookingStatus.toJson) BookingStatus? bookingStatus,@JsonKey(name: 'variants', toJson: _productsToJson) List<ProductSelectedModel>? products,@JsonKey(name: 'details') BookingOtherDetailsModel? otherDetails,@JsonKey(name: 'additional_charges') List<AdditionalChargesModel>? additionalCharges,@JsonKey(name: 'service_id', includeToJson: false, includeFromJson: false) int? serviceId,@JsonKey(name: 'pickup_time', includeToJson: false, includeFromJson: false) TimeOfDay? pickupTime,@JsonKey(name: 'return_time', includeToJson: false, includeFromJson: false) TimeOfDay? returnTime,@JsonKey(name: 'send_invoice', includeToJson: true, includeFromJson: false) bool sendPdfToWhatsApp,@JsonKey(name: 'running_kilometers') String? runningKilometers
});
...
/// Adds pattern-matching-related methods to [RequestBookingModel].
extension RequestBookingModelPatterns on RequestBookingModel {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _RequestBookingModel value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _RequestBookingModel() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _RequestBookingModel value)  $default,){
final _that = this;
switch (_that) {
case _RequestBookingModel():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _RequestBookingModel value)?  $default,){
final _that = this;
switch (_that) {
case _RequestBookingModel() when $default != null:
return $default(_that);case _:
...
class _RequestBookingModel implements RequestBookingModel {
  const _RequestBookingModel({@JsonKey(name: 'client_id') this.clientId, @JsonKey(name: 'staff_id') this.staffId, @JsonKey(name: 'client', toJson: _clientToJson, includeIfNull: false) this.client, @JsonKey(name: 'client_address') this.address, @JsonKey(name: 'booked_date') this.bookedDate, @JsonKey(name: 'pickup_date') this.pickupDate, @JsonKey(name: 'return_date') this.returnDate, @JsonKey(name: 'cooling_period_end') this.coolingPeriodDate, @JsonKey(name: 'advance_amount') this.advanceAmount, @JsonKey(name: 'security_amount') this.securityAmount, @JsonKey(name: 'discount_amount') this.discountAmount, @JsonKey(name: 'purchase_mode') this.purchaseMode, @JsonKey(name: 'description') this.description, @JsonKey(name: 'payment_method') this.paymentMethod, @JsonKey(name: 'delivery_status', toJson: DeliveryStatus.toJson) this.deliveryStatus, @JsonKey(name: 'booking_status', toJson: BookingStatus.toJson) this.bookingStatus, @JsonKey(name: 'variants', toJson: _productsToJson) final  List<ProductSelectedModel>? products, @JsonKey(name: 'details') this.otherDetails, @JsonKey(name: 'additional_charges') final  List<AdditionalChargesModel>? additionalCharges, @JsonKey(name: 'service_id', includeToJson: false, includeFromJson: false) this.serviceId, @JsonKey(name: 'pickup_time', includeToJson: false, includeFromJson: false) this.pickupTime, @JsonKey(name: 'return_time', includeToJson: false, includeFromJson: false) this.returnTime, @JsonKey(name: 'send_invoice', includeToJson: true, includeFromJson: false) this.sendPdfToWhatsApp = false, @JsonKey(name: 'running_kilometers') this.runningKilometers}): _products = products,_additionalCharges = additionalCharges;
  factory _RequestBookingModel.fromJson(Map<String, dynamic> json) => _$RequestBookingModelFromJson(json);
...
@override@JsonKey(name: 'pickup_time', includeToJson: false, includeFromJson: false) final  TimeOfDay? pickupTime;
@override@JsonKey(name: 'return_time', includeToJson: false, includeFromJson: false) final  TimeOfDay? returnTime;
@override@JsonKey(name: 'send_invoice', includeToJson: true, includeFromJson: false) final  bool sendPdfToWhatsApp;
@override@JsonKey(name: 'running_kilometers') final  String? runningKilometers;

/// Create a copy of RequestBookingModel
/// with the given fields replaced by the non-null parameter values.
@override @JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
_$RequestBookingModelCopyWith<_RequestBookingModel> get copyWith => __$RequestBookingModelCopyWithImpl<_RequestBookingModel>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$RequestBookingModelToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _RequestBookingModel&&(identical(other.clientId, clientId) || other.clientId == clientId)&&(identical(other.staffId, staffId) || other.staffId == staffId)&&(identical(other.client, client) || other.client == client)&&(identical(other.address, address) || other.address == address)&&(identical(other.bookedDate, bookedDate) || other.bookedDate == bookedDate)&&(identical(other.pickupDate, pickupDate) || other.pickupDate == pickupDate)&&(identical(other.returnDate, returnDate) || other.returnDate == returnDate)&&(identical(other.coolingPeriodDate, coolingPeriodDate) || other.coolingPeriodDate == coolingPeriodDate)&&(identical(other.advanceAmount, advanceAmount) || other.advanceAmount == advanceAmount)&&(identical(other.securityAmount, securityAmount) || other.securityAmount == securityAmount)&&(identical(other.discountAmount, discountAmount) || other.discountAmount == discountAmount)&&(identical(other.purchaseMode, purchaseMode) || other.purchaseMode == purchaseMode)&&(identical(other.description, description) || other.description == description)&&(identical(other.paymentMethod, paymentMethod) || other.paymentMethod == paymentMethod)&&(identical(other.deliveryStatus, deliveryStatus) || other.deliveryStatus == deliveryStatus)&&(identical(other.bookingStatus, bookingStatus) || other.bookingStatus == bookingStatus)&&const DeepCollectionEquality().equals(other._products, _products)&&(identical(other.otherDetails, otherDetails) || other.otherDetails == otherDetails)&&const DeepCollectionEquality().equals(other._additionalCharges, _additionalCharges)&&(identical(other.serviceId, serviceId) || other.serviceId == serviceId)&&(identical(other.pickupTime, pickupTime) || other.pickupTime == pickupTime)&&(identical(other.returnTime, returnTime) || other.returnTime == returnTime)&&(identical(other.sendPdfToWhatsApp, sendPdfToWhatsApp) || other.sendPdfToWhatsApp == sendPdfToWhatsApp)&&(identical(other.runningKilometers, runningKilometers) || other.runningKilometers == runningKilometers));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,clientId,staffId,client,address,bookedDate,pickupDate,returnDate,coolingPeriodDate,advanceAmount,securityAmount,discountAmount,purchaseMode,description,paymentMethod,deliveryStatus,bookingStatus,const DeepCollectionEquality().hash(_products),otherDetails,const DeepCollectionEquality().hash(_additionalCharges),serviceId,pickupTime,returnTime,sendPdfToWhatsApp,runningKilometers]);
...
/// @nodoc
abstract mixin class _$RequestBookingModelCopyWith<$Res> implements $RequestBookingModelCopyWith<$Res> {
  factory _$RequestBookingModelCopyWith(_RequestBookingModel value, $Res Function(_RequestBookingModel) _then) = __$RequestBookingModelCopyWithImpl;
@override @useResult
$Res call({
@JsonKey(name: 'client_id') int? clientId,@JsonKey(name: 'staff_id') int? staffId,@JsonKey(name: 'client', toJson: _clientToJson, includeIfNull: false) ClientRequestModel? client,@JsonKey(name: 'client_address') String? address,@JsonKey(name: 'booked_date') String? bookedDate,@JsonKey(name: 'pickup_date') String? pickupDate,@JsonKey(name: 'return_date') String? returnDate,@JsonKey(name: 'cooling_period_end') String? coolingPeriodDate,@JsonKey(name: 'advance_amount') int? advanceAmount,@JsonKey(name: 'security_amount') int? securityAmount,@JsonKey(name: 'discount_amount') int? discountAmount,@JsonKey(name: 'purchase_mode') String? purchaseMode,@JsonKey(name: 'description') String? description,@JsonKey(name: 'payment_method') PaymentMethod? paymentMethod,@JsonKey(name: 'delivery_status', toJson: DeliveryStatus.toJson) DeliveryStatus? deliveryStatus,@JsonKey(name: 'booking_status', toJson: BookingStatus.toJson) BookingStatus? bookingStatus,@JsonKey(name: 'variants', toJson: _productsToJson) List<ProductSelectedModel>? products,@JsonKey(name: 'details') BookingOtherDetailsModel? otherDetails,@JsonKey(name: 'additional_charges') List<AdditionalChargesModel>? additionalCharges,@JsonKey(name: 'service_id', includeToJson: false, includeFromJson: false) int? serviceId,@JsonKey(name: 'pickup_time', includeToJson: false, includeFromJson: false) TimeOfDay? pickupTime,@JsonKey(name: 'return_time', includeToJson: false, includeFromJson: false) TimeOfDay? returnTime,@JsonKey(name: 'send_invoice', includeToJson: true, includeFromJson: false) bool sendPdfToWhatsApp,@JsonKey(name: 'running_kilometers') String? runningKilometers
});
...
/// @nodoc
class __$RequestBookingModelCopyWithImpl<$Res>
    implements _$RequestBookingModelCopyWith<$Res> {
  __$RequestBookingModelCopyWithImpl(this._self, this._then);

  final _RequestBookingModel _self;
  final $Res Function(_RequestBookingModel) _then;

/// Create a copy of RequestBookingModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? clientId = freezed,Object? staffId = freezed,Object? client = freezed,Object? address = freezed,Object? bookedDate = freezed,Object? pickupDate = freezed,Object? returnDate = freezed,Object? coolingPeriodDate = freezed,Object? advanceAmount = freezed,Object? securityAmount = freezed,Object? discountAmount = freezed,Object? purchaseMode = freezed,Object? description = freezed,Object? paymentMethod = freezed,Object? deliveryStatus = freezed,Object? bookingStatus = freezed,Object? products = freezed,Object? otherDetails = freezed,Object? additionalCharges = freezed,Object? serviceId = freezed,Object? pickupTime = freezed,Object? returnTime = freezed,Object? sendPdfToWhatsApp = null,Object? runningKilometers = freezed,}) {
  return _then(_RequestBookingModel(
clientId: freezed == clientId ? _self.clientId : clientId // ignore: cast_nullable_to_non_nullable
as int?,staffId: freezed == staffId ? _self.staffId : staffId // ignore: cast_nullable_to_non_nullable
as int?,client: freezed == client ? _self.client : client // ignore: cast_nullable_to_non_nullable
as ClientRequestModel?,address: freezed == address ? _self.address : address // ignore: cast_nullable_to_non_nullable
