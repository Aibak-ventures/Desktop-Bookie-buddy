...
@override
int get hashCode => Object.hashAll([runtimeType,clientId,staffId,client,address,bookedDate,pickupDate,returnDate,coolingPeriodDate,advanceAmount,securityAmount,isSecurityPaid,discountAmount,purchaseMode,description,deliveryStatus,bookingStatus,const DeepCollectionEquality().hash(products),otherDetails,const DeepCollectionEquality().hash(additionalCharges),serviceId,pickupTime,returnTime,sendPdfToWhatsApp,runningKilometers,coolingPeriodType,securityPaymentAccountId,const DeepCollectionEquality().hash(payments),oldBookingAccountId,taxAmount]);
