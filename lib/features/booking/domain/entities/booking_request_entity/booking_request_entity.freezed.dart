...
mixin _$BookingRequestEntity {
 ...
 int? get clientId; int? get staffId; ClientRequestEntity? get client; String? get address; String? get bookedDate; String? get pickupDate; String? get returnDate; String? get coolingPeriodDate; int? get advanceAmount; int? get securityAmount; bool? get isSecurityPaid; int? get discountAmount; String? get purchaseMode; String? get description; DeliveryStatus? get deliveryStatus; BookingStatus? get bookingStatus; List<ProductSelectedEntity>? get products; BookingOtherDetailsEntity? get otherDetails; List<AdditionalChargesEntity>? get additionalCharges; int? get serviceId; TimeOfDay? get pickupTime; TimeOfDay? get returnTime; bool get sendPdfToWhatsApp; CoolingPeriodMode? get coolingPeriodType; int? get securityPaymentAccountId; List<BookingPaymentRequestEntity>? get payments; int? get oldBookingAccountId;// Only use this field when creating an old booking.
 int? get taxAmount;
...
@override
int get hashCode => Object.hashAll([runtimeType,clientId,staffId,client,address,bookedDate,pickupDate,returnDate,coolingPeriodDate,advanceAmount,securityAmount,isSecurityPaid,discountAmount,purchaseMode,description,deliveryStatus,bookingStatus,const DeepCollectionEquality().hash(products),otherDetails,const DeepCollectionEquality().hash(additionalCharges),serviceId,pickupTime,returnTime,sendPdfToWhatsApp,coolingPeriodType,securityPaymentAccountId,const DeepCollectionEquality().hash(payments),oldBookingAccountId,taxAmount]);

@override
String toString() {
  return 'BookingRequestEntity(clientId: $clientId, staffId: $staffId, client: $client, address: $address, bookedDate: $bookedDate, pickupDate: $pickupDate, returnDate: $returnDate, coolingPeriodDate: $coolingPeriodDate, advanceAmount: $advanceAmount, securityAmount: $securityAmount, isSecurityPaid: $isSecurityPaid, discountAmount: $discountAmount, purchaseMode: $purchaseMode, description: $description, deliveryStatus: $deliveryStatus, bookingStatus: $bookingStatus, products: $products, otherDetails: $otherDetails, additionalCharges: $additionalCharges, serviceId: $serviceId, pickupTime: $pickupTime, returnTime: $returnTime, sendPdfToWhatsApp: $sendPdfToWhatsApp, coolingPeriodType: $coolingPeriodType, securityPaymentAccountId: $securityPaymentAccountId, payments: $payments, oldBookingAccountId: $oldBookingAccountId, taxAmount: $taxAmount)';
}
...
class _BookingRequestEntity implements BookingRequestEntity {
  const _BookingRequestEntity({this.clientId, this.staffId, this.client, this.address, this.bookedDate, this.pickupDate, this.returnDate, this.coolingPeriodDate, this.advanceAmount, this.securityAmount, this.isSecurityPaid, this.discountAmount, this.purchaseMode, this.description, this.deliveryStatus, this.bookingStatus, final  List<ProductSelectedEntity>? products, this.otherDetails, final  List<AdditionalChargesEntity>? additionalCharges, this.serviceId, this.pickupTime, this.returnTime, this.sendPdfToWhatsApp = false, this.coolingPeriodType, this.securityPaymentAccountId, final  List<BookingPaymentRequestEntity>? payments, this.oldBookingAccountId, this.taxAmount}): _products = products,_additionalCharges = additionalCharges,_payments = payments;
...
@override final  bool? isSecurityPaid;
...
@override
int get hashCode => Object.hashAll([runtimeType,clientId,staffId,client,address,bookedDate,pickupDate,returnDate,coolingPeriodDate,advanceAmount,securityAmount,isSecurityPaid,discountAmount,purchaseMode,description,deliveryStatus,bookingStatus,const DeepCollectionEquality().hash(_products),otherDetails,const DeepCollectionEquality().hash(_additionalCharges),serviceId,pickupTime,returnTime,sendPdfToWhatsApp,coolingPeriodType,securityPaymentAccountId,const DeepCollectionEquality().hash(_payments),oldBookingAccountId,taxAmount]);
