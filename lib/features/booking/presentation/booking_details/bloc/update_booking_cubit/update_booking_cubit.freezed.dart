...
abstract class _Submitting implements UpdateBookingState {
...
class _$FailureImpl implements _Failure {
  const _$FailureImpl(final Map<String, dynamic> error) : _error = error;
...
abstract class _Failure implements UpdateBookingState {
  const factory _Failure(final Map<String, dynamic> error) = _$FailureImpl;
...
abstract class _Error implements UpdateBookingState {
