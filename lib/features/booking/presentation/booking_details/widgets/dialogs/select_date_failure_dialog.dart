...
List<ProductSelectedEntity> _getUnavailableProducts(
  List<int> unavailableProducts,
  ValueNotifier<List<ProductSelectedEntity>> selectedProductsNotifier,
...
Future<void> showUnavailableProductsDialog({
  ...
  required ValueNotifier<List<ProductSelectedEntity>> selectedProductsNotifier,
}) async {
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                ...
                '${unavailableDateFrom != null && unavailableDateTo != null ? '${unavailableDateFrom.formatToUiDate()} - ${unavailableDateTo.formatToUiDate()}' : unavailableDateFrom?.formatToUiDate() ?? ''}',
                ...
                children: [
                  TextButton(
                    onPressed: () {
                      ...
                      selectedProductsNotifier.value = selectedProductsNotifier
                          .value
                          .where(
                            (e) => !unavailableSelectedProducts.any(
                              (un) =>
                                  e.variant.variantId == un.variant.variantId,
                            ),
                          )
                          .toList();
                      dialogContext.pop();
