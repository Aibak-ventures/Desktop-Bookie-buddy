...
/// (booking today, sales/custom-work later), factored out of
/// `booking_details_action_bar.dart` so it isn't copy-pasted per feature.
///
/// Handles, in order:
...
/// );
/// ```
Future<void> printReceiptWithOverlay({
  required BuildContext context,
  required Future<PrintTicketEntity> Function(UserShopEntity shop) buildTicket,
