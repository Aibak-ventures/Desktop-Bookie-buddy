...
mixin _$QzPrinterState {
 ...
 PrinterBridgeStatus get status; List<PrinterDeviceEntity> get printers; String? get selectedPrinterName; String? get errorMessage;
...
@override
int get hashCode => Object.hash(runtimeType,status,const DeepCollectionEquality().hash(printers),selectedPrinterName,errorMessage);

@override
String toString() {
  return 'QzPrinterState(status: $status, printers: $printers, selectedPrinterName: $selectedPrinterName, errorMessage: $errorMessage)';
}
...
@useResult
$Res call({
 PrinterBridgeStatus status, List<PrinterDeviceEntity> printers, String? selectedPrinterName, String? errorMessage
});
...
/// Create a copy of QzPrinterState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? status = null,Object? printers = null,Object? selectedPrinterName = freezed,Object? errorMessage = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( PrinterBridgeStatus status,  List<PrinterDeviceEntity> printers,  String? selectedPrinterName,  String? errorMessage)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _QzPrinterState() when $default != null:
return $default(_that.status,_that.printers,_that.selectedPrinterName,_that.errorMessage);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( PrinterBridgeStatus status,  List<PrinterDeviceEntity> printers,  String? selectedPrinterName,  String? errorMessage)  $default,) {final _that = this;
switch (_that) {
case _QzPrinterState():
return $default(_that.status,_that.printers,_that.selectedPrinterName,_that.errorMessage);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( PrinterBridgeStatus status,  List<PrinterDeviceEntity> printers,  String? selectedPrinterName,  String? errorMessage)?  $default,) {final _that = this;
switch (_that) {
case _QzPrinterState() when $default != null:
return $default(_that.status,_that.printers,_that.selectedPrinterName,_that.errorMessage);case _:
  return null;
...
class _QzPrinterState implements QzPrinterState {
  const _QzPrinterState({this.status = PrinterBridgeStatus.unknown, final  List<PrinterDeviceEntity> printers = const [], this.selectedPrinterName, this.errorMessage}): _printers = printers;
...
@override
int get hashCode => Object.hash(runtimeType,status,const DeepCollectionEquality().hash(_printers),selectedPrinterName,errorMessage);
...
/// Create a copy of QzPrinterState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? status = null,Object? printers = null,Object? selectedPrinterName = freezed,Object? errorMessage = freezed,}) {
