...
class CreateTaxConfigurationUseCase {
  final ITaxConfigurationRepository _repository;

  const CreateTaxConfigurationUseCase(this._repository);

  Future<void> call({
    required TaxConfigurationRequestEntity taxConfiguration,
  }) => _repository.createTaxConfiguration(taxConfiguration: taxConfiguration);
}
