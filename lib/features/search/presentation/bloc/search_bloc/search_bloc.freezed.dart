...
abstract class _Search implements SearchEvent {
  const factory _Search(final String query,
      {final String? startDate, final String? endDate}) = _$SearchImpl;
...
class __$$LoadNextSearchResultsImplCopyWithImpl<$Res>
  ...
  $Res call({
    ...
    return _then(_$LoadNextSearchResultsImpl(
      null == query
          ? _value.query
          : query // ignore: cast_nullable_to_non_nullable
              as String,
...
class _$LoadNextSearchResultsImpl implements _LoadNextSearchResults {
  ...
  _$$LoadNextSearchResultsImplCopyWith<_$LoadNextSearchResultsImpl>
      get copyWith => __$$LoadNextSearchResultsImplCopyWithImpl<
          _$LoadNextSearchResultsImpl>(this, _$identity);
...
abstract class _LoadNextSearchResults implements SearchEvent {
  const factory _LoadNextSearchResults(final String query,
      {final String? startDate,
      final String? endDate}) = _$LoadNextSearchResultsImpl;
