...
import 'package:bookie_buddy_web/features/expense/presentation/bloc/cubit_add_expense/add_expense_cubit.dart';
...
Future<void> showProductAddExpenseDialog({
  ...
  return showDialog(
    ...
    builder: (context) => BlocProvider(
      create: (context) =>
          AddExpenseCubit(saveProductExpenseUsecase: getIt.get()),
      child: _ProductAddExpenseDialog(
        id: id,
...
class _ProductAddExpenseDialog extends StatefulWidget {
  final int? id;
  final int variantId;
  ...
  const _ProductAddExpenseDialog({
  ...
  @override
  State<_ProductAddExpenseDialog> createState() =>
      _ProductAddExpenseDialogState();
}

class _ProductAddExpenseDialogState extends State<_ProductAddExpenseDialog> {
