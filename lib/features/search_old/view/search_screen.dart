...
// // import 'package:bookie_buddy_web/features/search_old/view_model/bloc_search/search_bloc.dart';
...
//                     ),
//                   ),
//                   hintText: 'Enter client name, staff name, or booking ID...',
//                   suffixFunction: () {
//                     clearSearchResults();
//                     _clearDateFilter();
//                   },
...
//                     ),
//                     child: Text(
//                       'Date filter: ${_getFilterDisplayText()}',
//                       style: TextStyle(
//                         fontSize: ResponsiveHelper.getFontSize(
//                           context,
//                           mobile: 10,
...
//   Widget _buildBookingsList(BuildContext context, List<GlobalSearchModel> bookings,
...
//               itemCount: bookings.length + (nextPageUrl != null ? 1 : 0),
...
//     if (hasTextQuery && hasDateFilter) {
//       return 'No bookings found for "${searchController.text}" in selected date range';
//     } else if (hasTextQuery) {
//       return 'No bookings found for "${searchController.text}"';
...
//   String getDisplayText(BookingsModel booking) {
//     try {
//       final date = DateTime.parse(booking.pickupDate ?? '');
