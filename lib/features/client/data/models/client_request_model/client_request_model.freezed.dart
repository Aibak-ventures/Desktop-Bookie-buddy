...
@JsonKey(name: 'id', includeToJson: false, includeIfNull: false) int? get id;@JsonKey(name: 'name', includeIfNull: false) String? get name;@JsonKey(name: 'phone_1_e164', includeIfNull: false) String? get phone1;@JsonKey(name: 'phone_2_e164', includeIfNull: false) String? get phone2;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ClientRequestModel&&(identical(other.id, id) || other.id == id)&&(identical(other.name, name) || other.name == name)&&(identical(other.phone1, phone1) || other.phone1 == phone1)&&(identical(other.phone2, phone2) || other.phone2 == phone2));
}
...
@useResult
$Res call({
@JsonKey(name: 'id', includeToJson: false, includeIfNull: false) int? id,@JsonKey(name: 'name', includeIfNull: false) String? name,@JsonKey(name: 'phone_1_e164', includeIfNull: false) String? phone1,@JsonKey(name: 'phone_2_e164', includeIfNull: false) String? phone2
});
...
class _ClientRequestModel implements ClientRequestModel {
  const _ClientRequestModel({@JsonKey(name: 'id', includeToJson: false, includeIfNull: false) required this.id, @JsonKey(name: 'name', includeIfNull: false) this.name, @JsonKey(name: 'phone_1_e164', includeIfNull: false) this.phone1, @JsonKey(name: 'phone_2_e164', includeIfNull: false) this.phone2});
...
@override@JsonKey(name: 'phone_1_e164', includeIfNull: false) final  String? phone1;
@override@JsonKey(name: 'phone_2_e164', includeIfNull: false) final  String? phone2;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ClientRequestModel&&(identical(other.id, id) || other.id == id)&&(identical(other.name, name) || other.name == name)&&(identical(other.phone1, phone1) || other.phone1 == phone1)&&(identical(other.phone2, phone2) || other.phone2 == phone2));
}
