...
abstract class $LedgerExpenseGroupedModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({String date, List<ExpenseModel> expenses});
}
...
class _$LedgerExpenseGroupedModelImpl implements _LedgerExpenseGroupedModel {
  const _$LedgerExpenseGroupedModelImpl(
      {required this.date, required final List<ExpenseModel> expenses})
      : _expenses = expenses;
  ...
  @override
  String toString() {
    return 'LedgerExpenseGroupedModel(date: $date, expenses: $expenses)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, date, const DeepCollectionEquality().hash(_expenses));
