...
@useResult
$Res call({
 int id, String name, String? description,@JsonKey(name: 'main_service_name', fromJson: MainServiceType.fromString, toJson: MainServiceType.toJson) MainServiceType? mainServiceType, String? color, String? model, String? image,@JsonKey(name: 'thumbnail_image') String? thumbnailImage, String? category,@JsonKey(name: 'purchase_price') int? purchaseAmount,@JsonKey(name: 'price') int? price,@JsonKey(name: 'sale_price', fromJson: _salePriceFromJson) String? salePrice,@JsonKey(name: 'registration_number') String? registrationNumber,@JsonKey(name: 'pollution_expiry') String? pollutionExpiry,@JsonKey(name: 'insurance_expiry') String? insuranceExpiry,@JsonKey(name: 'fitness_expiry') String? fitnessExpiry,@JsonKey(name: 'barcode') String? barcode,@JsonKey(name: 'general_service_name') String? generalServiceName, Map<String, dynamic> attributes,@JsonKey(name: 'variants') List<ProductVariantModel> variants
});
...
class _ProductModel extends ProductModel {
  const _ProductModel({required this.id, required this.name, required this.description, @JsonKey(name: 'main_service_name', fromJson: MainServiceType.fromString, toJson: MainServiceType.toJson) this.mainServiceType, this.color, this.model, this.image, @JsonKey(name: 'thumbnail_image') this.thumbnailImage, this.category, @JsonKey(name: 'purchase_price') this.purchaseAmount, @JsonKey(name: 'price') this.price, @JsonKey(name: 'sale_price', fromJson: _salePriceFromJson) this.salePrice, @JsonKey(name: 'registration_number') this.registrationNumber, @JsonKey(name: 'pollution_expiry') this.pollutionExpiry, @JsonKey(name: 'insurance_expiry') this.insuranceExpiry, @JsonKey(name: 'fitness_expiry') this.fitnessExpiry, @JsonKey(name: 'barcode') this.barcode, @JsonKey(name: 'general_service_name') this.generalServiceName, final  Map<String, dynamic> attributes = const {}, @JsonKey(name: 'variants') required final  List<ProductVariantModel> variants}): _attributes = attributes,_variants = variants,super._();
