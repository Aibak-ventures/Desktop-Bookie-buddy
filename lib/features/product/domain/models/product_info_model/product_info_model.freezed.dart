...
@JsonKey(name: 'id', readValue: _idCustomRead) int get id;@JsonKey(name: 'product_id') int? get productId;@JsonKey(name: 'variant_id') int? get variantId;@JsonKey(name: 'product_name') String get name;@JsonKey(name: 'product_thumbnail', defaultValue: '') String? get image;@JsonKey(name: 'main_service_name', fromJson: MainServiceType.fromString) MainServiceType? get mainServiceType;@JsonKey(name: 'variant_attribute') String? get variantAttribute; String? get color; String? get category; String? get model; int get quantity;@JsonKey(defaultValue: 0) int get amount;@JsonKey(name: 'measurements', fromJson: _parseMeasurements) List<MeasurementValueModel> get measurements;// Available stock from the variant
 int? get stock;@JsonKey(name: 'remaining_stock') int? get remainingStock;
...
@override@JsonKey(name: 'product_thumbnail', defaultValue: '') final  String? image;
