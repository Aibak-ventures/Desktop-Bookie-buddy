...
import 'package:bookie_buddy_web/features/product/presentation/transfer_product/widgets/transfer_product_select_shop_section.dart';
import 'package:bookie_buddy_web/features/product/presentation/transfer_product/bloc/matching_product_bloc/matching_product_bloc.dart';
import 'package:bookie_buddy_web/features/product/presentation/transfer_product/bloc/transfer_product_cubit/transfer_product_cubit.dart';
                ...
                onPressed: () {
                  ...
                  context.push(
                    MultiBlocProvider(
                      providers: [
                        BlocProvider(
                          create: (context) => MatchingProductBloc(
                            getMatchingProducts: getIt.get(),
                          )..add(
                        ...
                        BlocProvider(
                          create: (context) => TransferProductCubit(
                            transferProduct: getIt.get(),
                          ),
                        ),
                      ],
...
class TransferProductTextTitle extends StatelessWidget {
  final String text;
  const TransferProductTextTitle({
    super.key,
    required this.text,
  });
