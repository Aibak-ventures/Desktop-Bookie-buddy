...
Future<int?> showVariantSelectionDialog({
  ...
  ProductVariantEntity? selectedVariant = variants.first;
                            ...
                            return GestureDetector(
                              onTap: () {
                                setState(() {
                                  ...
                                  log(
                                    'current selected variant: $selectedVariant',
                                  );
                                });
                              },
                              child: Container(
              ...
              Row(
                ...
                children: [
                  ...
                  ElevatedButton(
                    onPressed: () {
                      log(
                        'selected variant: $selectedVariant, onPop: ${selectedVariant?.id ?? productId}',
                      );
