...
_$$LedgerSecurityAmountGroupedModelImplFromJson(Map<String, dynamic> json) =>
    _$LedgerSecurityAmountGroupedModelImpl(
      dailySecurityAmounts: (json['dailySecurityAmounts'] as List<dynamic>)
          .map(
            (e) => LedgerSecurityAmountDailyModel.fromJson(
...
) => <String, dynamic>{'dailySecurityAmounts': instance.dailySecurityAmounts};
