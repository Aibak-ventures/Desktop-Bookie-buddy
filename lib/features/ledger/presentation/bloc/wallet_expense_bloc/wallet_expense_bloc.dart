...
class WalletExpenseBloc extends Bloc<WalletExpenseEvent, WalletExpenseState> {
  final GetLedgerExpensePaginatedUseCase _getExpense;
  final DeleteExpenseUsecase _deleteExpenseUsecase;

  WalletExpenseBloc({
    required GetLedgerExpensePaginatedUseCase getExpense,
  ...
  Future<void> _onLoadExpense(
    ...
    try {
      final result = await _getExpense(page: 1, clientId: event.clientId);
  ...
  Future<void> _onLoadNextPageExpense(
    ...
    try {
      ...
      final result = await _getExpense(page: nextPage, clientId: s.clientId);
