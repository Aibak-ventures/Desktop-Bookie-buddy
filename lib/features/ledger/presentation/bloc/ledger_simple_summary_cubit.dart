...
class LedgerSimpleSummaryCubit extends Cubit<DailySummaryModel?> {
  final GetLedgerDaySummaryUseCase _getDaySummary;
  LedgerSimpleSummaryCubit({required GetLedgerDaySummaryUseCase getDaySummary})
      : _getDaySummary = getDaySummary,
        super(null);
  ...
  Future<void> getLedgerDaySummary(
    ...
    final daySummary = cache == null || force
        ? await _getDaySummary(date: date, clientId: clientId)
        : cache;
